...
export default function manifest (): MetadataRoute.Manifest {
  return {
    ...
    theme_color: '#161312',
    icons: [
      { src: '/goaltip-mark.svg?v=20260709b', sizes: 'any', type: 'image/svg+xml', purpose: 'any' },
      { src: '/goaltip-mark.svg?v=20260709b', sizes: 'any', type: 'image/svg+xml', purpose: 'maskable' }
    ]
  }
}
